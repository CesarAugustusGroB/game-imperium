...
function dispatch(encounter: string, actionIndex: number): EncounterOutcome {
  switch (encounter) {
    case 'rest':
      addMorale(20);
    ...
    default:
      // boss / scout / recruit / siege / hazard / unknown — not generated by
      // the campaign hex map yet. Future-proof by returning a no-op.
      return NOOP;
  }
}
